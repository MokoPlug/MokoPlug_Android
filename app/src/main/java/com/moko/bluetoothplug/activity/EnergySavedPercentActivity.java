...
public class EnergySavedPercentActivity extends BaseActivity {
    ...
    @Bind(R.id.et_energy_saved_percent)
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent != null) {
                ...
                if (MokoConstants.ACTION_ORDER_TIMEOUT.equals(action)) {
                    ToastUtils.showToast(EnergySavedPercentActivity.this, R.string.timeout);
                }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_confirm:
                ...
                int energySavedInterval = MokoSupport.getInstance().energySavedInterval;
                MokoSupport.getInstance().sendOrder(mMokoService.writeEnergySavedParams(percent, energySavedInterval));
                break;
        }
    }
